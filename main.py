...
print_invariants(mapM(Int,2,1,-3,eor,1,-1,2))
print_invariants(mapM(GaussInt,1,3,6,(2,3),(0,-3),(12,-18),(2,-3),(6,-9),(0,-18)))
print_elementaries(mapM(Int,2,1,-3,eor,1,-1,2))
print_elementaries(mapM(GaussInt,1,3,6,(2,3),(0,-3),(12,-18),(2,-3),(6,-9),(0,-18)))

print(rcf(M(-1,-2,6,-1,0,3,-1,-1,4)))